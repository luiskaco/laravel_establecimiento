                ...
                <fieldset class="border p-4">
                    ...
                    <div class="form-group">
                        ...
                        <select
                            ...
                            @foreach ($categorias as $categoria)
                                <option
                                    value="{{$categoria->id}}"
                                    {{$establecimiento->categoria_id == $categoria->id ? 'selected': null}}>{{$categoria->nombre}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file"
                               ...
                               <img style="width:200px; margin-top:20px;" src="{{Storage::url($establecimiento->imagen_principal)}}" alt="">
                    </div>
                </fieldset>
